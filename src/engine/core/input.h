...
enum
    ...
    static const unsigned int NUM_MOUSEBUTTONS = 256;
    static const unsigned int NUM_KEYS = 512;
    
    Input();
    
    inline bool getKey(unsigned int index)         const { return m_keys[index]; }
    inline bool getKeyDown(unsigned int index)     const { return m_keyDowns[index]; }
    inline bool getKeyUp(unsigned int index)       const { return m_keyUps[index]; }
    inline bool getMouseButton(unsigned int index) const { return m_mouseButtons[index]; }
    inline bool getMouseDown(unsigned int index)   const { return m_mouseDowns[index]; }
	...
	inline void warpMouse(const Vector2f &pos)			 const { warpMouse(pos.getX(), pos.getY()); }
    ...
    inline void setMouseButton(unsigned int index, bool value) { m_mouseButtons[index] = value; }
    inline void setMouseDown(unsigned int index, bool value)   { m_mouseDowns[index] = value; }
...
private:
    ...
    bool    m_keyDowns[NUM_KEYS];
    bool    m_keyUps[NUM_KEYS];
    bool    m_mouseButtons[NUM_MOUSEBUTTONS];
    bool    m_mouseUps[NUM_MOUSEBUTTONS];
    bool    m_mouseDowns[NUM_MOUSEBUTTONS];
    int     m_mouseX;
    int     m_mouseY;
    Window  *m_window;
};
